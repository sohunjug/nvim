...
local plug_map = {
    ...
    ["i|<CR>"] = map_cmd([[compe#confirm({ 'keys': "\<Plug>delimitMateCR", 'mode': '' })]]):with_noremap():with_expr()
        :with_nowait(),
    -- person keymap
    ["n|mf"] = map_cr("<cmd>lua require('internal.fsevent').file_event()<CR>"):with_silent():with_nowait()
        :with_noremap(),
    ...
    ["n|<C-f>"] = map_cmd("<cmd>lua require('lspsaga.action').smart_scroll_with_saga(1)<CR>"):with_silent()
        :with_noremap():with_nowait(),
    ["n|<C-b>"] = map_cmd("<cmd>lua require('lspsaga.action').smart_scroll_with_saga(-1)<CR>"):with_silent()
        :with_noremap():with_nowait(),
    ...
    ["n|<Leader>ft"] = map_cr("NvimTreeFindFile"):with_noremap():with_silent(),
    ...
    ["n|<Leader>bc"] = map_cu("Telescope neoclip"):with_noremap():with_silent(),
    ...
    ["n|<Leader>fs"] = map_cu("Telescope help_tags"):with_noremap():with_silent(),
    ["n|<Leader>fd"] = map_cu("Telescope dotfiles path=" .. global.home .. "Code/dotfiles"):with_noremap():with_silent(),
