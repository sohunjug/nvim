...
local plug_map = {
    ...
    ["n|<Leader>fd"] = map_cu("Telescope dotfiles path=" .. os.getenv "HOME" .. "/.dotfiles"):with_noremap()
        :with_silent(),
    ...
    ["n|<leader>cl"] = map_cu("ProComment"):with_noremap():with_silent(),
    ["x|<leader>cl"] = map_cr "ProComment",
