...
local plugin_dir = vim_path .. '/lua/plugins'
...
function Packer:load_plugins()
    ...
    local get_plugins_list = function()
        ...
        for _, f in ipairs(tmp) do list[#list + 1] = f:sub(#plugin_dir - 6, -1) end
        return list
    end
...
function plugins.convert_compile_file()
    ...
    if vim.fn.isdirectory(data_dir .. 'lua') ~= 1 then os.execute('mkdir -p ' .. data_dir .. 'lua') end
