...
components.active[3][8] = { provider = statusline_style.left, hl = { fg = colors.grey, bg = colors.one_bg } }

components.active[3][9] = { provider = statusline_style.left, hl = { fg = colors.green, bg = colors.grey } }

components.active[3][10] = { provider = statusline_style.position_icon, hl = { fg = colors.black, bg = colors.green } }
