...
local icon_styles = {
   default = { left = "", right = " ", main_icon = "  ", vi_mode_icon = " ", position_icon = " " },
   arrow = { left = "", right = "", main_icon = "  ", vi_mode_icon = " ", position_icon = " " },

   block = { left = " ", right = " ", main_icon = "   ", vi_mode_icon = "  ", position_icon = "  " },

   round = { left = "", right = "", main_icon = "  ", vi_mode_icon = " ", position_icon = " " },

   slant = { left = " ", right = " ", main_icon = "  ", vi_mode_icon = " ", position_icon = " " },
}
...
components.active[1][1] = {
   ...
   right_sep = { str = statusline_style.right, hl = { fg = colors.nord_blue, bg = colors.one_bg2 } },
}

components.active[1][2] = { provider = statusline_style.right, hl = { fg = colors.one_bg2, bg = colors.lightbg } }
...
components.active[1][4] = {
   ...
   right_sep = { str = statusline_style.right, hi = { fg = colors.lightbg2, bg = colors.statusline_bg } },
}
...
components.active[3][7] = { provider = statusline_style.left, hl = { fg = colors.grey, bg = colors.one_bg } }

components.active[3][8] = { provider = statusline_style.left, hl = { fg = colors.green, bg = colors.grey } }

components.active[3][9] = { provider = statusline_style.position_icon, hl = { fg = colors.black, bg = colors.green } }
