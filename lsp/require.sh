...
npm i -g bash-language-server typescript-language-server neovim pyright vscode-json-languageserver dockerfile-language-server-nodejs vim-language-server
